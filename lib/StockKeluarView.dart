...
class StockKeluar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(title: Text('Stock Keluar')),
                  ...
                  children: [
                    ...
                    Image.network(
                      controller.detailBarang.value == null
                          ...
                          : baseURL +
                              controller.detailBarang.value['gambar']
                                  .toString(),
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          if (controller.detailBarang.value['stock']!['qty']+1 <=
                              qty.value) {
                            Get.snackbar('Stock Tidak Cukup', '',
                                snackPosition: SnackPosition.BOTTOM,
                                backgroundColor: Colors.red,
                                colorText: Colors.white);
                          } else {
                            controller.stockKeluar(
                                id, qty.value, _keteranganController.text ?? "");
